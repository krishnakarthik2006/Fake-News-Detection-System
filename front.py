...
def render_source_card(source: SourceEvidence) -> str:
    ...
    <article class="source-card">
      ...
      <div class="source-card__footer">
        <span>{html.escape(format_verdict(source.verdict))}</span>
...
def build_result_block(document: DocumentReport) -> str:
    ...
    <section class="document-result">
      ...
      <div class="document-result__stats">
        <div>
...
def main() -> None:
    load_or_train_model()
    print(f"Fake News Detector running at http://{HOST}:{PORT}")
